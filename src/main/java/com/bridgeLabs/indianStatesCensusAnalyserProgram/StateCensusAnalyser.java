...
public class StateCensusAnalyser {
	public int loadStateCensusData(String csvFilePath) throws CensusAnalyserException {
		try (Reader reader = Files.newBufferedReader(Paths.get(csvFilePath));) {
			Iterator<CSVStateCensus> censusCsvIterator = new OpenCsvBuilder().getIteratorFromCsv(reader,
	...
	public int loadStateCodesData(String csvFilePath) throws CensusAnalyserException {
		try (Reader reader = Files.newBufferedReader(Paths.get(csvFilePath));) {
			Iterator<CSVStates> codesCsvIterator = new OpenCsvBuilder().getIteratorFromCsv(reader, CSVStates.class);
